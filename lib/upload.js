...
// Use NEXT_PUBLIC keys if you only need Storage; otherwise, for full server access, use SERVICE_ROLE_KEY
 ...
 */
export async function uploadFileServer(buffer, folder = '', fileName = 'file.bin', mimeType = 'application/octet-stream') {
  try {
 ...
 */
export function validateImageFileServer(fileName, mimeType, size) {
 ...
 */
export function validatePdfFileServer(fileName, mimeType, size) {
